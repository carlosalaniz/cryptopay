...
export class Api<SecurityDataType extends unknown> {
  ...
  wallets = {
     ...
     * @secure
     */
    list: (userId: string, params: RequestParams = {}) =>
     ...
     * @secure
     */
    listWithEnoughBalance: (userId: string, data: ListWithEnoughBalancePayload, params: RequestParams = {}) =>
      this.http.request<ListWithEnoughBalanceData, any>({
        path: `/wallets/${userId}/enough-balance`,
        method: "POST",
        body: data,
        secure: true,
     ...
     * @secure
     */
    balance: (userId: string, walletType: WalletType, params: RequestParams = {}) =>
      this.http.request<BalanceData, any>({
        path: `/wallets/${userId}/${walletType}/balance`,
        method: "GET",
        secure: true,
        ...params,
      }),
     ...
     * @secure
     */
    deposit: (userId: string, walletType: WalletType, params: RequestParams = {}) =>
      this.http.request<DepositData, any>({
        path: `/wallets/${userId}/${walletType}/deposit/address`,
        method: "GET",
        secure: true,
        ...params,
      }),
     ...
     * @secure
     */
    withdraw: (userId: string, walletType: WalletType, data: WithdrawPayload, params: RequestParams = {}) =>
      this.http.request<WithdrawData, WithdrawError>({
        path: `/wallets/${userId}/${walletType}/withdraw`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
  ...
  payments = {
     ...
     * @secure
     */
    accountPayments: (userId: string, params: RequestParams = {}) =>
     ...
     */
    list: (userId: string, params: RequestParams = {}) =>
      this.http.request<ListResult, any>({
        path: `/payments/${userId}/service-accounts`,
        method: "GET",
        secure: true,
        ...params,
      }),
     ...
     * @secure
     */
    pay: (userId: string, serviceAccountId: string, data: PayPayload, params: RequestParams = {}) =>
      this.http.request<PayData, PayError>({
        path: `/payments/${userId}/${serviceAccountId}/pay`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
     ...
     * @secure
     */
    oneTimePayment: (userId: string, data: OneTimePaymentPayload, params: RequestParams = {}) =>
      this.http.request<OneTimePaymentData, OneTimePaymentError>({
        path: `/payments/${userId}/one-time-payment/pay`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
     ...
     * @secure
     */
    cashWithdrawalOxxo: (userId: string, data: CashWithdrawalOxxoPayload, params: RequestParams = {}) =>
      this.http.request<CashWithdrawalOxxoData, CashWithdrawalOxxoError>({
        path: `/payments/${userId}/cash-withdrawal/oxxo`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
     ...
     * @secure
     */
    estimate: (userId: string, data: EstimatePayload, params: RequestParams = {}) =>
      this.http.request<EstimateData, EstimateError>({
        path: `/payments/${userId}/estimate`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
